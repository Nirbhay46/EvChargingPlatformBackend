package io.evcharge.payment.config;
...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, BookingCreatedEvent> bookingEventConsumerFactory() {
        JsonDeserializer<BookingCreatedEvent> deser = new JsonDeserializer<>(BookingCreatedEvent.class, false);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, BookingCreatedEvent> bookingEventListenerFactory(
            KafkaTemplate<String, Object> tpl) {
        ConcurrentKafkaListenerContainerFactory<String, BookingCreatedEvent> f = new ConcurrentKafkaListenerContainerFactory<>();
        f.setConsumerFactory(bookingEventConsumerFactory());
        // DLT + exponential backoff for poison messages
